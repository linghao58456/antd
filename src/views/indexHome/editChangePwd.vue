    ...
    <div id="edit-change">
        ...
        <a-form :form="edit_form" :label-col="{span:10}" @submit="changePwd">
            ...
            <a-form-item label="验证码" class="new-code-form-item" style="margin-bottom: 5px">
                ...
                <div @click="refreshCode" style="margin-left: 610px;margin-top: -40px;width: 120px">
                    <verification-code :identifyCode="identifyCode" style="cursor: pointer"/>
                </div>
            </a-form-item>
            <a-button type="primary" class="btn" style="margin-left: 510px">
                <router-link :to="{name:'index'}">取消</router-link>
            </a-button>
...
<script>
    import VerificationCode from "../loginHome/verificationCode";
